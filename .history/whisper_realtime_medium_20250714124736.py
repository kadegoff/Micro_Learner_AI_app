...
class WhisperRealtimeMedium:
    def __init__(self, model_size="medium", device="cpu", compute_type="int8"):
        ...
        self.chunk_duration = 1.5    # 50% faster response
        self.min_audio_length = 0.6  # 40% faster trigger  
        self.silence_duration = 0.8  # 47% faster sentence detection
