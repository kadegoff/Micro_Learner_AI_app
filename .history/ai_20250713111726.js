...
function setupHistoryPanel() {
  ...
  // FIXED: Remove any existing listeners to prevent duplicates
  const newHistoryButton = historyButton.cloneNode(true);
  historyButton.parentNode.replaceChild(newHistoryButton, historyButton);

  // Get fresh reference
  const freshHistoryButton = document.getElementById("historyButton");

  console.log("📚 Setting up history button click listener...");
  freshHistoryButton.addEventListener("click", function (e) {
    e.preventDefault();
    e.stopPropagation();
  ...
  document.addEventListener("click", function (e) {
    if (historyPanel && historyPanel.classList.contains("show")) {
      ...
      const isNotHistoryButton =
        !freshHistoryButton || !freshHistoryButton.contains(e.target);
...
historyManager.toggleHistoryPanel = function (show) {
  ...
  if (show === undefined) {
    ...
    // Set specific state
    console.log("📚 Setting specific state to:", show);
    panel.classList.toggle("show", show);
    button?.classList.toggle("active", show);
  }
  ...
  if (panel.classList.contains("show")) {
    ...
    // Force reflow
    panel.offsetHeight;
    console.log("📚 Forced panel to display: block");
  }
};
