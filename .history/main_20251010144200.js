...
// Detect platform and set feed URL
...
const feedUrl = `https://microlearnerai.com/backend/download/${platformFolder}/`;

if ($DebugTestMode) {
  console.log(`Auto-updater configured for: ${platformFolder}`);
}
