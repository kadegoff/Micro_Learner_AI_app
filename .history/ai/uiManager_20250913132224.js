...
function selectAIModel(modelId) {
  ...
  // Update ALL dropdown buttons to show the selected model
  buttons.forEach((button) => {
    // Update the button text to show the selected model
    const buttonText = button.querySelector(".button-text");
    if (buttonText) {
      buttonText.textContent = cleanName;
    } else {
      // Fallback if the button doesn't have a specific text element
