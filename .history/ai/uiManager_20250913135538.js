...
function updateAuthDropdown(isEditSection = false) {
  // Update main chat controls
  ...
  // Also update any edit section dropdown if it exists
  const editDropdownContainer = document.querySelector(
    "#editAiDropdownContainer"
  );
  if (editDropdownContainer) {
    ...
    editDropdownContainer.innerHTML = generateDropdownHTML(currentModel);
  }
}
