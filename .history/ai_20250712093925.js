  ...
  showFallbackPreview: function (attachment) {
    ...
    previewContainer.innerHTML = `
        <div class="screenshot-preview-header">
            ...
            <span class="screenshot-size">${this.formatFileSize(
              attachment.size
            )}</span>
            <button class="remove-screenshot-btn" onclick="chatInputManager.removeScreenshotPreview()">✕</button>
        </div>
        <div class="screenshot-preview-fallback">
            <p>📷 Screenshot attached (preview unavailable)</p>
        </div>
    `;
  ...
  showScreenshotPreview: function (attachment) {
    ...
    <div class="screenshot-preview-image">
      <img src="data:image/png;base64,${cleanData}" 
           ...
           onerror="this.style.display='none'; this.parentNode.innerHTML='<p>📷 Preview failed to load</p>'" />
    </div>
  `;
