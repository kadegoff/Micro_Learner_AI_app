...
function preventWindowGlitching() {
  ...
  window.preventMinimize = false; // Make globally accessible
  ...
  window.addEventListener("resize", (e) => {
    ...
    // ONLY prevent auto-maximize, not minimize
    if (
    ...
    moveTimeout = setTimeout(() => {
      ...
      // DON'T reset preventMinimize here
    }, 1000);
  });

  // Override ONLY maximize attempts, not minimize
  ...
  // Don't interfere with minimize operations
  window.preventMaximize = preventMaximize; // Make accessible
}
