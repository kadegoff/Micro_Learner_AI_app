...
var aiWindowState = {
 ...
 restoreFromMinimized: function () {
  ...
  console.log("🔼 AI: Current body visibility:", document.body.style.visibility);
  ...
  if (!needsRestore) {
    console.log("⚠️ AI: Window appears to already be restored, but continuing anyway...");
  }
  ...
  setTimeout(() => {
    ...
    console.log("🔍 AI: Body display after restore:", document.body.style.display);
    console.log("🔍 AI: Body visibility after restore:", document.body.style.visibility);
    console.log("🔍 AI: Body opacity after restore:", document.body.style.opacity);
    ...
    if (isActuallyVisible) {
      ...
      console.error("❌ AI: ========== RESTORE FAILED - TRYING FALLBACK ==========");

      // FALLBACK method - force everything
      console.log("🔧 AI: Applying fallback restore methods...");
      document.body.style.cssText = "display: block !important; visibility: visible !important; opacity: 1 !important; position: relative !important; z-index: 999999 !important;";
 ...
 notifyControlCenter: function (messageType) {
  ...
  try {
    ...
    if (messageType === "AI_MINIMIZING" || messageType === "AI_MINIMIZED") {
      ...
      this.setMinimizedState(true);
    } else if (messageType === "AI_RESTORING" || messageType === "AI_RESTORED") {
