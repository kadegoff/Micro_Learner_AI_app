...
const ApiClient = {
  ...
  chat: async function (data) {
    const response = await fetch(
      `${this.baseUrl}/api/index.php?endpoint=chat`,
      {
        method: "POST",
  ...
  processTranscript: async function (data) {
    const response = await fetch(
      `${this.baseUrl}/api/index.php?endpoint=transcript`,
      {
        method: "POST",
        headers: this.getHeaders(),
        body: JSON.stringify(this.addTokenToBody(data)),
  ...
  getSettings: async function () {
    const response = await fetch(
      `${this.baseUrl}/api/index.php?endpoint=settings`,
      {
  ...
  getUsage: async function () {
    const response = await fetch(
      `${this.baseUrl}/api/index.php?endpoint=usage`,
      {
        method: "POST", // Changed from GET to POST
        headers: this.getHeaders(),
        body: JSON.stringify(this.addTokenToBody({})), // Send empty object with token
  ...
  verifyAuth: async function () {
    const response = await fetch(
      `${this.baseUrl}/api/index.php?endpoint=auth&action=verify`,
      {
        method: "POST",
        headers: this.getHeaders(),
        body: JSON.stringify(this.addTokenToBody({})), // Send empty object with token
