...
var chatInputManager = {
  ...
  setupEventListeners: function () {
    ...
    if (attachmentButton && attachmentInput) {
      ...
      console.log("✅ Attachment event listeners setup complete");
    } else {
      console.warn("⚠️ Attachment button or input not found");
    }

    console.log("✅ Chat input event listeners setup complete");
  },
