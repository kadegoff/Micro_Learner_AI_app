...
function createSingleWindow() {
  ...
  // ✅ Load ONE of your HTML files - pick the main one
  mainWindow.loadFile("control.html"); // Or whichever is your main window
...
app.whenReady().then(async () => {
  ...
  loadAuthData();
  // ⚠️ COMMENT OUT createWindows() temporarily for testing
  // createWindows(); // Don't create windows automatically

  // ✅ INSTEAD: Load a simple single HTML file first
  createSingleWindow();
