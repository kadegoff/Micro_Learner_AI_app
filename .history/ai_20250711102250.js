...
var aiWindowState = {
  ...
  // ... (keep all your existing methods: minimizeToControl, restoreFromMinimized, etc.)

  // EXISTING METHODS (don't change these, just add the new ones above)
  minimizeToControl: function () {
    console.log("🔽 minimizeToControl called");
    // ... existing minimize code ...
  },
...
// UPDATED: Enhanced setupWindowControls function
