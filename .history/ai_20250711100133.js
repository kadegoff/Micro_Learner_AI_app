...
var aiWindowState = {
  ...
  setupCommunication: function () {
    ...
    // Monitor localStorage for control messages more frequently
    ...
    // Check for control messages more frequently
    setInterval(checkControlMessages, 250); // Reduced from 500ms

    // Check minimized state from current session
    ...
    if (sessionMinimized === "true" || localMinimized === "true") {
      console.log("🫥 AI starting minimized from session/control state");
      document.body.style.display = "none";
      document.body.style.visibility = "hidden";
      this.isMinimized = true;

      // Ensure control knows about this state
      this.notifyControlCenter("AI_MINIMIZED");
    } else {
