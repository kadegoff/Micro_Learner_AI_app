  ...
  setupEventDelegation: function () {
    ...
    document.addEventListener("click", function (event) {
      ...
      if (
        ...
        if ($DebugTestMode) {
          console.log(
            "🎯 IGNORING content block button in window controls area"
          );
        }
        return;
      }
...
`;
  ...
  // ENHANCED: Show thinking with minimum display time tracking and SVG wave animation
    ...
    <div class="wave-bounce-container">
      <div class="bounce-item">
        <svg viewBox="0 0 100 100">
          <defs>
            <linearGradient id="thinkingGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style="stop-color:#4facfe;stop-opacity:1" />
              <stop offset="100%" style="stop-color:#00f2fe;stop-opacity:1" />
            </linearGradient>
          </defs>
          <circle cx="50" cy="50" r="45" fill="url(#thinkingGradient1)" stroke="#fff" stroke-width="2"/>
        </svg>
      </div>
      <div class="bounce-item">
        <svg viewBox="0 0 100 100">
          <defs>
            <linearGradient id="thinkingGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style="stop-color:#4facfe;stop-opacity:1" />
              <stop offset="100%" style="stop-color:#00f2fe;stop-opacity:1" />
            </linearGradient>
          </defs>
          <circle cx="50" cy="50" r="45" fill="url(#thinkingGradient2)" stroke="#fff" stroke-width="2"/>
        </svg>
      </div>
      <div class="bounce-item">
        <svg viewBox="0 0 100 100">
          <defs>
            <linearGradient id="thinkingGradient3" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style="stop-color:#4facfe;stop-opacity:1" />
              <stop offset="100%" style="stop-color:#00f2fe;stop-opacity:1" />
            </linearGradient>
          </defs>
          <circle cx="50" cy="50" r="45" fill="url(#thinkingGradient3)" stroke="#fff" stroke-width="2"/>
        </svg>
      </div>
    </div>
  `;
  ...
  sendChatMessageDirect: function (data) {
    ...
    fetch(`${CONFIG.BACKEND_URL}/api/index.php?endpoint=chat`, {
      ...
      .then((response) => {
        ...
        if (response.debug_log && $DebugTestMode) {
        ...
        if (
          ...
          if (response.usage_recorded && $DebugTestMode) {
...
var chatInputManager = {
  ...
  addAttachmentToContainer: function (attachment) {
    ...
    try {
      ...
      if ($DebugTestMode) {
        console.log(
          "📎 Attachment element HTML created, adding to container..."
        );
      }
  ...
  showLargeContentPreview: function (attachment) {
    if ($DebugTestMode) {
      console.log(
        "👁️ Creating large content preview for:",
        attachment.filename
      );
    }
...
var aiWindowState = {
    ...
    window.addEventListener("blur", () => {
      ...
      setTimeout(() => {
        if (!this.isWindowFocused) {
          if ($DebugTestMode) {
            console.log(
              "[Focus] Window still unfocused - adding inactive class"
            );
          }
  ...
  startMinimized: function () {
    ...
    try {
      ...
      if ($DebugTestMode) {
        console.log(
          "[startMinimized] setMinimizedState completed successfully"
        );
      }
